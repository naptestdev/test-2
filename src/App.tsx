              ...
              {(isDesktop || isViewMore ? data : data.slice(0, 3)).map(
                (item, index) => (
                  <>
                    ...
                    >
                      <td className="pl-[2vw] md:pl-[7vw] py-2 md:rounded-none rounded-l-[6px]">
                        ...
                        <td colSpan={6}>
                          <div className="flex gap-5 bg-[#F0F0F0] py-5 px-[3vw] md:px-[7vw]">
                            {item.badges.map((badge) => (
                              <div
                                className="flex-shrink-0 flex flex-col items-center px-2 py-2 md:py-5 w-[100px] md:w-[140px] bg-white border border-[#FFD042] rounded"
                                key={badge}
                              >
                                <img
